...
#define WHOIS_AWAY       8
#define WHOIS_REALIP     9
#define WHOIS_INFO_COUNT 10
...
typedef struct
{
  ...
  void (*OnKilled)(struct BN_SInfo *,const char [],const char []); // Who Msg
  void (*OnDisconnected)(struct BN_SInfo *,const char []); // Msg
  void (*OnExcessFlood)(struct BN_SInfo *,const char []); // Msg
  void (*OnLinks)(struct BN_SInfo *,const char [],const char *[],const int); // Server List Count
  void (*OnStats)(struct BN_SInfo *,const char [],const char *[],const int); // Server List Count
  void (*OnVersion)(struct BN_SInfo *,const char [],const char [],const char []); // Server Version Infos
  void (*OnLocalUsers)(struct BN_SInfo *,const char [],const char []); // Server LocalUsers
  void (*OnGlobalUsers)(struct BN_SInfo *,const char [],const char []); // Server GlobalUsers
...
#ifdef BAHAMUT
  void (*OnSJoin)(struct BN_SInfo *,const char [],time_t,time_t,const char [],const char [],const char [],const char *[],const int); // Chan Time1 Time2 Modes Extra1 Extra2 Nicks Count (Extra1&2 = Keyword&Limit, in any order, or NULL)
...
void BN_SendDCCSendRequest(BN_PInfo,const char *,const int, char *,const int,void *);
